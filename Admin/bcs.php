    ...
    <h2 class="text-center">Enter your questions here</h2>
      ...
      <form action="save_questions.php" method="POST">
        ...
        for($i=44;$i>=10;$i--)
        {
         ...
         echo " 
          <input type='radio' class='btn-check' name='question_type' id='bcs$i' value='bcs$i' autocomplete='off'>
          <label class='btn btn-outline-danger my-1' for='bcs$i'>$i th BCS</label>
         ";
